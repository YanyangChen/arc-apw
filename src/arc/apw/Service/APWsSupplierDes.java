...
@Service
public abstract class APWsSupplierDes extends ACFaAppService{
    
    public APWsSupplierDes() throws Exception {
        super();
        // TODO Auto-generated constructor stub
    }

    public abstract String getSupplierNameBySupplierNo(String supplier_code) throws Exception;
}